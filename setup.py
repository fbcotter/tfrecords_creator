...
def get_version():
    with open("tfrecords_creator/__init__.py") as f:
        for line in f:
...
setup(
    ...
    description=("Reading/writing datasets to TF Records files."),
    license="MIT",
    keywords="image datasets, cifar, pascal, mnist, imagenet",
    url="https://github.com/fbcotter/tfrecords_creator.git",
